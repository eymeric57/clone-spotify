...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::subMenu('Gestion Avatars', 'fa fa-image')->setSubItems([
            MenuItem::linkToCrud('Ajouter un avatar', 'fa fa-plus', Avatar::class)->setAction(Crud::PAGE_NEW),
            MenuItem::linkToCrud('Voir les avatar', 'fa fa-eye', Avatar::class)
        ]);
